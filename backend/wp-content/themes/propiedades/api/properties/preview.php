...
add_action('rest_api_init', 'one_property_endpoint_preview');

function one_property_endpoint_preview() {
  register_rest_route('propiedades', '/properties/property/preview', array(
    'methods' => 'GET',
    'callback' => 'get_one_property_preview',
  ));
}

function get_one_property_preview($request) {
  $data = array();
